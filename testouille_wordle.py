...
# __init__ -- Found 2315 words...
# compute_words_information -- Computing and saving exhaustive information for best opening...
# build_pattern_compendium -- Building pattern compendium...
# build_pattern_compendium -- Found 237 patterns in 11.55 second(s)...
# load_build_cache_compendium -- Building cache compendium...
# load_build_cache_compendium -- Added 4230557 entries in cache compendium in 9.68 second(s)...
# __init__ -- Language launcher for wordle.txt initialised in 297.13 second(s)
...
# compute_words_information -- Computing and saving exhaustive information for best opening...
# build_pattern_compendium -- Building pattern compendium...
# build_pattern_compendium -- Found 237 patterns in 14.85 second(s)...
# load_build_cache_compendium -- Building cache compendium...
# load_build_cache_compendium -- Added 4230557 entries in cache compendium in 22.11 second(s)...
# __init__ -- Language launcher for wordle.txt initialised in 294.31 second(s)
